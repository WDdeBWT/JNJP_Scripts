(function(e){
    e.fn.cntl=function(t){
        var n=e.extend({revealbefore:200,anim_class:"cntl-animate",onreveal:null},t);
            return this.each(function(){function o(){
                for(var r=0;r<t.length;r++){
                    i[r]={};
                    i[r]["top"]=e(t[r]).offset().top+n.revealbefore;
                    // i[r]["top"]=n.revealbefore;
                    i[r]["elm"]=e(t[r])}u()
                }
                function u(){
                    ...
                    for(var u=0;u<i.length;u++){
                        if(i[u].top>t&&i[u].top<o){
                            ...
                            var a=i[u].elm.position().top + 125;
                            if(a>s){s=a}r.height(s)
                        }
                    }
                }
